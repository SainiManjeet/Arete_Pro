...
import com.apnitor.arete.pro.materialshowcaseview.shape.NoShape;
import com.apnitor.arete.pro.materialshowcaseview.shape.OvalShape;
...
import com.apnitor.arete.pro.materialshowcaseview.target.Target;
import com.apnitor.arete.pro.materialshowcaseview.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public int getViewMeasuredHeight() {
        return viewMeasuredHeight;
    }

    public void setViewMeasuredHeight(int viewMeasuredHeight) {
        this.viewMeasuredHeight = viewMeasuredHeight;
    }
   ...
   /* public void skip() {
    ...
    public static class Builder {
        ...
        public Builder setScrollable(Boolean scrollable) {
            showcaseView.setScrollable(scrollable);
            return this;
        }

        public Builder setViewMeasuredHeight(int height) {
            showcaseView.setViewMeasuredHeight(height);
            return this;
        }
